...
/*     */   {
/*  35 */     super(paramContext, "msp.db", null, 1);
/*  36 */     this.c = new WeakReference(paramContext);
/*     */   }
/*     */ 
/*     */   public final void onCreate(SQLiteDatabase paramSQLiteDatabase)
/*     */   {
/*  41 */     paramSQLiteDatabase.execSQL("create table if not exists tb_tid (name text primary key, tid text, key_tid text, dt datetime);");
/*     */   }
/*     */ 
/*     */   public final void onUpgrade(SQLiteDatabase paramSQLiteDatabase, int paramInt1, int paramInt2)
/*     */   {
/*  46 */     paramSQLiteDatabase.execSQL("drop table if exists tb_tid");
/*  47 */     paramSQLiteDatabase.execSQL("create table if not exists tb_tid (name text primary key, tid text, key_tid text, dt datetime);"); } 
/*     */   // ERROR //
...
/*     */     //   12	56	89	java/lang/Exception
/*     */     //   12	56	123	finally } 
/* 188 */   private static boolean a(SQLiteDatabase paramSQLiteDatabase, String paramString1, String paramString2) { String str = "select count(*) from tb_tid where name=?";
/*     */ 
/* 190 */     int i = 0;
/* 191 */     Cursor localCursor = null;
/*     */     try
/*     */     {
/* 194 */       if ((
/* 194 */         localCursor = paramSQLiteDatabase.rawQuery(str, new String[] { e(paramString1, paramString2) }))
/* 194 */         .moveToFirst()) {
/* 195 */         i = localCursor.getInt(0);
/*     */       }
/*     */ 
/* 199 */       if (localCursor != null)
/* 200 */         localCursor.close();
/*     */     }
...
/*     */   {
/* 206 */     return paramString1 + paramString2;
/*     */   }
/*     */ 
...
/*     */   {
/* 211 */     String str = "insert into tb_tid (name, tid, key_tid, dt) values (?, ?, ?, datetime('now', 'localtime'))";
/* 212 */     paramString3 = Des.a(paramString3, DeviceInfo.c((Context)this.c.get()));
/* 213 */     paramSQLiteDatabase.execSQL(str, new Object[] { e(paramString1, paramString2), paramString3, paramString4 });
/*     */ 
/* 215 */     paramString1 = paramSQLiteDatabase; paramSQLiteDatabase = 0; paramString2 = "select name from tb_tid where tid!='' order by dt asc"; if ((paramString2 = paramString1.rawQuery(paramString2, null)).getCount() <= 14) { paramString2.close(); return; } paramString4 = new String[paramString3 = paramString2.getCount() - 14]; if (paramString2.moveToFirst()) do { paramString4[paramSQLiteDatabase] = paramString2.getString(0); paramSQLiteDatabase++; } while ((paramString2.moveToNext()) && (paramString3 > paramSQLiteDatabase)); paramString2.close(); for (paramSQLiteDatabase = 0; paramSQLiteDatabase < paramString4.length; paramSQLiteDatabase++) if (!TextUtils.isEmpty(paramString4[paramSQLiteDatabase])) a(paramString1, paramString4[paramSQLiteDatabase]);
/*     */   }
/*     */ 
...
/*     */   {
/* 220 */     String str = "update tb_tid set tid=?, key_tid=?, dt=datetime('now', 'localtime') where name=?";
/* 221 */     paramString3 = Des.a(paramString3, DeviceInfo.c((Context)this.c.get()));
/* 222 */     paramSQLiteDatabase.execSQL(str, new Object[] { paramString3, paramString4, e(paramString1, paramString2) });
/*     */   }
/*     */ 
...
/* 236 */     int i = 0;
/* 237 */     Object localObject = "select name from tb_tid where tid!='' order by dt asc";
/*     */ 
/* 239 */     if ((
/* 239 */       localObject = paramSQLiteDatabase.rawQuery((String)localObject, null))
/* 239 */       .getCount() <= 14) {
/* 240 */       ((Cursor)localObject).close();
/*     */       return;
/*     */     }
/*     */     int j;
/* 244 */     String[] arrayOfString = new String[j = ((Cursor)localObject).getCount() - 14];
/*     */ 
/* 245 */     if (((Cursor)localObject).moveToFirst()) {
/*     */       do {
/* 247 */         arrayOfString[i] = ((Cursor)localObject).getString(0);
/* 248 */         i++;
/* 249 */       }while ((((Cursor)localObject).moveToNext()) && (j > i));
/*     */     }
/* 251 */     ((Cursor)localObject).close();
/* 252 */     for (i = 0; i < arrayOfString.length; i++)
/* 253 */       if (!TextUtils.isEmpty(arrayOfString[i]))
/* 254 */         a(paramSQLiteDatabase, arrayOfString[i]);
/*     */   }
/*     */ }
